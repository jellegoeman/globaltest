...
\Rclass{exprSet}. It has 7,129 genes for 72 samples on Affymetrix
...
reduced the data set to only 407 probes (those probes annotated to
15 pathways contained in our example annotation
\Robject{annotation.vandeVijver}) and only 100 random patients.
...
testing adjustments, see the \Rpackage{multtest} package.
...
inaccurate for this method and are reported as zero.
